...
class TestSchemaRegistryClient(unittest.TestCase):
    ...
    def test_get_raw_schema(self):
        ...
        schema = self.schema_registry.get_raw_schema(1000)
        self.assertEqual(ast.literal_eval(schema)["namespace"], "lsst.v10_0")
    ...
    def test_get_schema_decoder(self):
        ...
        self.schema_registry.get_schema_decoder(1000)
        self.assertIn(1000, self.schema_registry._cached_decoders)
